...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="download data from NSIDC-0051 Monthly for a given year using NASA EarthData login credentials"
    )
    parser.add_argument(
        "-o",
        "--out_path",
        ...
        dest="out_path",
        type=str,
        help="output directory to dump out the downloaded data",
    )
    parser.add_argument(
        "-y",
        "--year",
        ...
        dest="year",
        type=int,
        help="year to download from the NSIDC-0051 Monthly data archive.",
    )
    parser.add_argument(
        "-u",
        "--username",
